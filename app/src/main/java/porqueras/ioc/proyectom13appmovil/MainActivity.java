...
import porqueras.ioc.proyectom13appmovil.utilidades.CertificateUtils;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Gestionamos los certificados y el cifrado comunicaciones SSL/TLS
        CertificateUtils.inicializarManejoDeCertidicados(getResources());
